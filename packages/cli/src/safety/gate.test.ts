...
const context = { scenarioHash: "scenario", modelHash: "model", environment: "test", origin: "https://example.test", now: new Date("2026-09-22T00:00:00Z") };
const permit = { scenarioHash: "scenario", modelHash: "model", environment: "test", origin: "https://example.test", actionIds: ["save"], targetScopes: ["user:42"], expiresAt: "2026-09-23T00:00:00Z" };
